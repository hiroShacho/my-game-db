    ...
    <div className="p-4 space-y-8">
      ...
      <section>
        ...
        <p className="text-sm text-gray-600">
          ...
          各種コンテンツの情報は徐々に更新していきます。お待ちくだセい。
        </p>
      </section>
      ...
      {/* 最新バージョンの注目コンテンツ */}
      <section>
        <h2 className="text-lg font-semibold mb-2">ver5.0の注目コンテンツ</h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/weapons/w_61" className="block bg-white shadow p-4 rounded hover:bg-blue-50">
            <h3 className="font-semibold">リンゼイ</h3>
            <p className="text-sm text-gray-600">リンゼイの武器詳細をチェック</p>
          </Link>
        ...
        <div className="mt-8 space-y-6">
          <div>
            ...
            <Image
              src="/images/official-calendar.png"
              alt="公式カレンダー"
              width={900}
              height={400}
          ...
          <div>
            ...
            <Image
              src="/images/edited-calendar.png"
