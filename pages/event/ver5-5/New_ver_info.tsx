...
const costumeImages = [
  {
    src: "/ver_event/Outfit_VelvetSiren.PNG",
    alt: "ガチャマシン：「セクシーデビル」",
    label: "ガチャマシン：「セクシーデビル」",
    date: "11/25(火)メンテナンス後 -  12/30(火)06:00（JST）",
  },
  {
    src: "/ver_event/Simulacrum_Veronica.PNG",
    alt: "プレミアムアバター：ヴェロニカ「聖夜巡行」",
    label: "プレミアムアバター：ヴェロニカ「聖夜巡行」",
    date: "11/25(火)メンテナンス後 -  12/30(火)06:00（JST）",
  }
];
...
const gachaDates = [
  ...
  {
    label: "復刻ガチャマシン：「海塩スターコーデ」",
    date: "11/25(火)メンテナンス後 - 12/13(土) 06:00（JST）",
  },
  {
    label: "復刻ガチャマシン：「創り上げる未来」",
    date: "11/25(火)メンテナンス後 - 12/13(土) 06:00（JST）",
  },
  {
    label: "プレミアムアバター：ヴェロニカ「聖夜巡行」",
  ...
  {
    label: "【復刻】プレミアムアバター：メリル・アムド「悠々夏日」",
    date: "11/25(火)メンテナンス後 - 12/13(土) 06:00（JST）",
  },
  {
  ...
  {
    label: "【復刻】プレミアムアバター：シードル「しなやかな夏」",
    date: "11/25(火)メンテナンス後 - 12/13(土) 06:00（JST）",
  },
];
...
export default function NewVerInfo() {
  ...
  return (
    <>
      <Head>
        <title>ver5.5アップデート情報まとめ | 幻塔攻略データベース</title>
      ...
      <div className="w-full max-w-full min-h-screen space-y-8 px-2 sm:px-6 py-4">
        ...
        {/* 新キャラクター・ヴェロニカ実装！ */}
        <section>
          <SectionTitle icon={<><span title="雷">⚡</span><span title="ヴェロニカ">🔫</span></>}>
            新キャラクター・ヴェロニカ実装！
          </SectionTitle>
          ...
          <div className="flex gap-4 flex-wrap mb-4">
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/w_67_img.PNG" alt="ヴェロニカ武器" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">武器：ヴェロニカ</span>
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/m_63_img.PNG" alt="ヴェロニカボリション" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">ボリション：ヴェロニカ</span>
                <div className="text-xs mt-1 text-gray-600">詳細ページへ</div>
              </div>
            </Link>
          </div>
        ...
        <section>
          ...
          <a
            href="https://tof.perfectworld.com/jp/news/notice/20251120/259419.shtml"
            target="_blank"
