...
// 武器IDリスト（物理・異能その他属性復刻ガチャ対象）
const rerunWeaponIds = [
  "w_43", "w_52", "w_53", "w_57", "w_58", "w_59", "w_60", "w_62"
];
// 対象武器データ取得
...
const costumeImages = [
  {
    src: "/ver_event/Outfit_IvoryWing.PNG",
    alt: "ガチャマシン：「アイボリーの艦翼」",
    label: "ガチャマシン：「アイボリーの艦翼」",
    date: "10/28(火)メンテナンス後 - 11/25(火) 06:00（JST）",
  },
  {
    src: "/ver_event/Outfit_MacaronTown.PNG",
    alt: "ガチャマシン：「マカロンシティ」",
    label: "ガチャマシン：「マカロンシティ」",
    date: "10/28(火)メンテナンス後 - 11/25(火) 06:00（JST）",
  }
];
...
const gachaDates = [
  ...
  {
    label: "【復刻】期間限定BOXガチャ：「ドキドキカーニバルナイト」",
    date: "10/28(火)メンテナンス後 - 11/11(火) 06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター：アントリア「神殺しのアントリア」",
    date: "10/28(火)メンテナンス後 - 11/11(火) 06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター：キャロット「宇宙のピグシー」",
    date: "10/28(火)メンテナンス後 - 11/11(火) 06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター：南音「澄冷幽音」",
    date: "10/28(火)メンテナンス後 - 11/11(火) 06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター：ネメシス・ヴォイド「紫曜星の誓い」",
    date: "10/28(火)メンテナンス後 - 11/11(火) 06:00（JST）",
  },
  {
    label: "【水着】【復刻】プレミアムアバター：ノーラ「海岸の風」",
    date: "10/28(火)メンテナンス後 - 11/11(火) 06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター：アンカー「青春時代」",
    date: "10/28(火)メンテナンス後 - 11/11(火) 06:00（JST）",
  },
];
...
export default function NewVerInfo() {
  ...
  return (
    <>
      <Head>
        <title>ver5.4アップデート情報まとめ | 幻塔攻略データベース</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="幻塔 ver5.4 新アップデート内容まとめページ" />
      </Head>
      <div className="w-full max-w-full min-h-screen space-y-8 px-2 sm:px-6 py-4">
        ...
        {/* 新キャラクター・ナント実装！ */}
        <section>
          <SectionTitle icon={<><span title="物理">🔨</span><span title="ナント">🐉</span></>}>
            新キャラクター・ナント実装！
          </SectionTitle>
          ...
          <div className="flex gap-4 flex-wrap mb-4">
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/w_66_img.PNG" alt="ヘレンネ武器" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">武器：ナント</span>
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/m_62_img.PNG" alt="ナントボリション" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">ボリション：ナント</span>
                <div className="text-xs mt-1 text-gray-600">詳細ページへ</div>
              </div>
            </Link>
          </div>
        ...
        <section>
          ...
          <div className="flex gap-4 flex-wrap mb-4">
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/w_47_img.PNG" alt="ヤノ武器" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-700">武器：ヤノ</span>
                <div className="text-xs mt-1 text-gray-600">詳細ページへ</div>
              </div>
            </Link>
          </div>
        ...
        <section>
          ...
          <a
            href="https://tof.perfectworld.com/jp/news/notice/20251024/258990.shtml"
            target="_blank"
