...
const weapon = {
  ...
  constellations: [
    {
      level: "1凸",
      description: "物理ダメージ+7%、スキル「玄宿・潜龍溯淵」発動時に獲得する闘気が60ポイントから120ポイントに増加する。",
      tags: ["物理ダメージUP"]
    },
    {
      level: "2凸",
    ...
    {
      level: "5凸",
      description: "最終与ダメージ+10%。闘気を20ポイント消費するごとに自身の最大HPの5%を回復する。ダメージを受けると10%の被ダメージ減少を獲得し、最大30%まで。30秒間持続。",
      tags: ["最終ダメージUP","回復","被ダメージDOWN"]
    },
    {
      level: "6凸",
      description: "物理属性ダメージ+24%。闘気余震のダメージが6900%まで上昇する。。",
      tags: ["物理ダメージUP"]
    }
  ]
};
...
const matrix = {
  ...
  effects: [
    ...
    {
      set: "4セット効果",
      effect: "全属性ダメージ+18%/22%/26%/30%。武器「青霜」をセットするとキャラクターは追加で最終ダメージ+14%。装備すると常時有効。複数セット装着している場合は★ランクが一番高いセットのみ有効。",
