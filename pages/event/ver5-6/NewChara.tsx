...
const weapon = {
  ...
  strategy: "スキル使用後は通常攻撃を連打すればOK。スキル使用後の10秒間が特に高火力なので、サポーターやアルケーのバフは最初のスキル使用後の10秒間に集中させよう。",
  ratingScore: 4,
  ratingAttacker: 4.5,
  ratingSupporter: 1,
  ratingReroll: 3,
  ...
  constellations: [
    ...
    {
      level: "5凸",
      description: "最終ダメージ+6%。武器-ブラッディ・シャークがターゲットに命中すると、自身の最大HPの6%を回復する。1秒ごとに最大1回発動可能。",
      tags: ["全属性耐性無視","耐性無視","死亡回避"]
    },
    {
      level: "6凸",
      description: "最終ダメージ+25%、炎属性ダメージ+8%。",
...
const matrix = {
  ...
  effects: [
    {
      set: "2セット効果",
      effect: "炎属性攻撃力+26%/28%/30%/32%。\nスキル-決死の深呑発動後10秒間、武器-ブラッディ・シャークによる与ダメージ+250%。装備すると常時有効。複数セット装着している場合は★ランクが一番高いセットのみ有効。",
      tags: ["炎属性攻撃力UP","与ダメージUP","常時有効"]
    },
    {
      set: "4セット効果",
      effect: "炎属性ダメージ+22%/26%/30%/34%、武器-ブラッディ・シャーク装備後、炎属性ダメージ+15%。装備すると常時有効。複数セット装着している場合は★ランクが一番高いセットのみ有効。",
      tags: ["炎属性ダメージUP","常時有効"]
    }
  ],
  ratingComment: "与ダメージ+250%。サリディは明らかに2セット効果前提で作られている。",
  ratingStars: "4.5"
};
