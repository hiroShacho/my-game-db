...
const rerunWeaponIds = [
  "w_65", "w_61", "w_56", "w_51", "w_68", "w_58", "w_53", "w_64", "w_60", "w_55", "w_66", "w_62", "w_57", "w_67", "w_63", "w_59", "w_54",
];
// 対象武器データ取得
...
const costumeImages = [
  {
    src: "/ver_event/Outfit_AuspiceBlossom.PNG",
    alt: "ガチャマシン：「金躍紅梅」",
    label: "ガチャマシン：「金躍紅梅」",
    date: "03/10(火)メンテナンス後 -  04/14(火)06:00（JST）",
  },
  {
    src: "/ver_event/Simulacrum_Agleia.PNG",
    alt: "プレアバ：アグレア「純白の誓約」",
    label: "プレアバ：アグレア「純白の誓約」",
    date: "03/10(火)メンテナンス後 -  04/14(火)06:00（JST）",
  }
];
...
const gachaDates = [
  ...
  {
    label: "【復刻】ガチャマシン：「新春華」",
    date: "03/10(火)メンテナンス後 -  03/28(土)06:00（JST）",
  },
  {
    label: "【復刻】ガチャマシン：「山水の緑」",
    date: "03/28(土)06:00（JST） -  04/14(火)06:00（JST）",
  },
  {
    label: "【復刻】ガチャマシン：「明け星遊覧」",
    date: "03/28(土)06:00（JST） -  04/14(火)06:00（JST）",
  },
  {
    label: "【復刻】ガチャマシン：「威風堂々」",
    date: "03/28(土)06:00（JST） -  04/14(火)06:00（JST）",
  },
  {
    label: "プレミアムアバター：アグレア「純白の誓約」",
    date: "03/10(火)メンテナンス後 -  04/14(火)06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター：全属性",
    date: "03/10(火)メンテナンス後 -  03/28(土)06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター：氷属性",
    date: "03/10(火)メンテナンス後 -  04/14(火)06:00（JST）",
  },
];
...
export default function NewVerInfo() {
  ...
  return (
    <>
      <Head>
        <title>ver5.7アップデート情報まとめ | 幻塔攻略データベース</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="幻塔 ver5.7 新アップデート内容まとめページ" />
      </Head>
      <div className="w-full max-w-full min-h-screen space-y-8 px-2 sm:px-6 py-4">
        ...
        {/* 新キャラクター・アグレア実装！ */}
        <section>
          <SectionTitle icon={<><span title="氷">🧙‍♀️</span><span title="アグレア">🎮</span></>}>
            新キャラクター・アグレア実装！
          </SectionTitle>
          ...
          <div className="flex gap-4 flex-wrap mb-4">
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/w_70_img.PNG" alt="アグレア武器" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">武器：アグレア</span>
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/m_66_img.PNG" alt="アグレアボリション" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">ボリション：アグレア</span>
                <div className="text-xs mt-1 text-gray-600">詳細ページへ</div>
              </div>
            </Link>
          </div>
        ...
        <section>
          ...
          <a
            href="https://tof.perfectworld.com/jp/news/notice/20260304/261129.shtml"
            target="_blank"
