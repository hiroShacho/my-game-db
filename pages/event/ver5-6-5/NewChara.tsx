...
const weapon = {
  ...
  constellations: [
    ...
    {
      level: "6凸",
      description: "最終ダメージ+26%、氷属性ダメージ+8%。\n時の心の攻撃命中時、敵に2秒間のスロウ効果99%を付与。",
...
const matrix = {
  ...
  effects: [
    ...
    {
      set: "4セット効果",
      effect: "氷属性ダメージ+35%/46%/58%/70%、武器-時の心を装備後、最終ダメージ+20%。装備すると常時有効。複数セット装着している場合は★ランクが一番高いセットのみ有効。",
      tags: ["氷属性ダメージUP","最終ダメージUP","常時有効"]
    }
  ],
  ratingComment: "4セットの効果が表記通りでは無いので何とも言えないが、アグレアを使うなら2セットは確保したい。",
  ratingStars: "3.5"
};
