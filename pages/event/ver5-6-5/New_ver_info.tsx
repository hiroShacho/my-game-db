...
const costumeImages = [
  {
    src: "/ver_event/Outfit_SpringSplendorAttireReissue.PNG",
    alt: "ガチャマシン：「華麗なる新春」",
    label: "ガチャマシン：「華麗なる新春」",
    date: "02/03(火)メンテナンス後 -  02/21(土)06:00（JST）",
  },
  {
    src: "/ver_event/Outfit_RoseGift.PNG",
    alt: "ガチャマシン：「薔薇の礼賛」",
    label: "ガチャマシン：「薔薇の礼賛」",
    date: "02/03(火)メンテナンス後 -  02/21(土)06:00（JST）",
  }
...
const gachaDates = [
  ...
  {
    label: "【復刻】プレミアムアバター：炎限定キャラ",
    date: "02/03(火)メンテナンス後 -  03/10(火)06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター",
    date: "02/03(火)メンテナンス後 -  02/21(土)06:00（JST）",
...
export default function NewVerInfo() {
  ...
  return (
    <>
      <Head>
        <title>ver5.65アップデート情報まとめ | 幻塔攻略データベース</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="幻塔 ver5.65 新アップデート内容まとめページ" />
      </Head>
      <div className="w-full max-w-full min-h-screen space-y-8 px-2 sm:px-6 py-4">
        ...
        {/* 新キャラクター・サリディ実装！ */}
        <section>
          <SectionTitle icon={<><span title="炎">🦈</span><span title="サリディ">✂️</span></>}>
            新キャラクター・サリディ実装！
          </SectionTitle>
          ...
          <div className="flex gap-4 flex-wrap mb-4">
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/w_69_img.PNG" alt="サリディ武器" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">武器：サリディ</span>
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/m_65_img.PNG" alt="サリディボリション" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">ボリション：サリディ</span>
                <div className="text-xs mt-1 text-gray-600">詳細ページへ</div>
              </div>
            </Link>
          </div>
        ...
        <section>
          ...
          <a
            href="https://tof.perfectworld.com/jp/news/notice/20260129/260626.shtml"
            target="_blank"
