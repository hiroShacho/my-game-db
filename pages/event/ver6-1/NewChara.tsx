...
const weapon = {
  ...
  name: "フェアリーリング",
  avatar: "ゲルフィン",
  description: "神秘的なサーカスの舞台道具。エルフやフェアリーの踊りで生み出されたという。単なる道具に留まらず、異世界へと繋がり、時空を超える力さえ秘めていると噂されている。",
  strategy: "連携スキルでバランスドスタンスを獲得してから通常攻撃とスキルを交互に発動してスキル-グランドフィナーレで〆よう。\n完凸効果はアグレアと組む前提な効果なので完凸を目指す場合は注意。",
  ratingScore: 4,
  ratingAttacker: 4,
  ratingSupporter: 1,
  ratingReroll: 3.5,
  ratingExplore: 1,
  ratingText: "氷・強攻のアタッカー。\nヘレンネに代わるダブルアタッカーの1人として最適編成で活躍してくれる。\nスキルは通常攻撃を1段出すごとに発動でき、連携スキル⇒通常1段目⇒第1スキル⇒通常2段目⇒第2スキル⇒通常3段目⇒第3スキル⇒第4スキルの流れで火力を出せる。\n一見複雑そうだが通常攻撃とスキルを同時 or 交互に連打していれば勝手に発動してくれるので操作自体は簡単な部類。注意点として、第4スキルは第3スキルの後に入る座るモーションの途中で解放される。この座るモーションを途中でジャンプキャンセルすると第4スキルが解放されないことがあるので下手にキャンセルはしないようにしよう。",
  videoUrls: ["https://youtu.be/0EwuapTP7d8"],
  tags: ["限定","SSR","氷・物理","強攻","アタッカー"],
  skillIds: [
    "s_7401",
    "s_7402",
    "s_7403",
  ...
  constellations: [
    {
      level: "1凸",
      description: "氷属性ダメージ+9%。\n武器-フェアリーリングがバックグラウンドにある時、「舞台のオーラ」を毎秒1Pt（最大10Pt）獲得する。武器-フェアリーリングをフロントに切り替えると、「舞台のオーラ」Pt×最大HP×3%のシールドを獲得する。重複獲得は自身の最大HP×50%で、シールドの持続時間は30秒。",
      tags: ["氷属性ダメージUP"]
    },
    {
      level: "2凸",
    ...
    {
      level: "3凸",
      description: "連携スキル-ステージタイムの発動完了後、「見せ場」を6Pt獲得する。武器-フェアリーリングの任意の攻撃時に「見せ場」を1Pt消費し、追加で攻撃力×3,000%の範囲通常攻撃ダメージを1回与える。0.3秒ごとに最大1回まで発動可能、60秒間持続。他の武器に切り替えると解除。",
      tags: [""]
    },
    {
      level: "4凸",
    ...
    {
      level: "5凸",
      description: "最終ダメージ+12%。\n武器-フェアリーリングが3凸の追加ダメージ「見せ場」を発動すると、自身の最大HPの6%を回復する。",
      tags: ["最終ダメージUP","回復"]
    },
    {
      level: "6凸",
      description: "氷属性ダメージ+31%\n。武器-フェアリーリングがバックグラウンドにある時、他の武器でスキルを発動すると「ボルテージ」を1Pt獲得できる。「ボルテージ」が5Ptに達すると、第4スキル-グランドフィナーレはすべての「ボルテージ」を消費し、ダメージは2倍になる。",
      tags: ["氷属性ダメージUP"]
    }
  ]
};
...
const matrix = {
  ...
  name: "反転する座標",
  avatar: "ゲルフィン",
  description: "ゲルフィンのボリション（テストサーバー）",
  effects: [
    {
      set: "2セット効果",
      effect: "氷属性攻撃力+28%/30%/32%/34%。\n武器-フェアリーリングのセット時に発生するヘイト値-90%。装備すると常時有効。複数セット装着している場合は★ランクが一番高いセットのみ有効。",
      tags: ["氷属性攻撃力UP","常時有効"]
    },
    {
      set: "4セット効果",
      effect: "最終ダメージ+18%/22%/26%/30、武器-フェアリーリングをセットしている時、追加で最終ダメージ+20%。装備すると常時有効。複数セット装着している場合は★ランクが一番高いセットのみ有効。",
      tags: ["最終ダメージUP","常時有効"]
    }
  ],
  ratingComment: "2セットは不要だが相変わらず4セットが強いので火力を求めるなら無凸確保はしておきたい。",
  ratingStars: "4"
};
...
const trait = {
  ...
  name: "驚異のバランシング",
  avatar: "ゲルフィン",
  description: "最終ダメージ+18%。\n武器-フェアリーリングをセットしている時、追加で氷属性ダメージ+22%",
  rating: "最適編成で火力が上がる特性はゲルフィンだけなので必然的に採用することになる。",
  tags: ["最終ダメージUP","氷属性ダメージUP"]
};
...
export default function Ver52NewCharaPage() {
  ...
  return (
    <>
      <Head>
        <title>【幻塔攻略】Ver6.2新武器・ボリション・アバター特性まとめ | 幻塔攻略データベース</title>
        <meta name="description" content="幻塔（Tower of Fantasy）Ver6.2新武器・ボリション・アバター特性のテストサーバー先行情報まとめページ。" />
      </Head>
      <SidebarLayout>
        <div className="max-w-3xl mx-auto space-y-8 px-2 sm:px-6 py-6">
          <h1 className="text-2xl sm:text-3xl font-bold mb-6">Ver6.2 新武器・ボリション・アバター特性まとめ</h1>
