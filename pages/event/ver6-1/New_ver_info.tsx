...
const costumeImages = [
  {
    src: "/ver_event/Outfit_SeabreezeWhispers.PNG",
    alt: "【復刻】ガチャマシン：「海風のささやき」",
    label: "【復刻】ガチャマシン：「海風のささやき」",
    date: "06/30(火)メンテナンス後 -  07/18(土)06:00（JST）",
  },
  {
    src: "/ver_event/Simulacrum_Flame.PNG",
    alt: "【復刻】プレアバセット：炎",
    label: "【復刻】プレアバセット：炎",
    date: "06/30(火)メンテナンス後 -  08/04(火)06:00（JST）",
  }
];
...
export default function NewVerInfo() {
  ...
  return (
    <>
      <Head>
        <title>ver6.1アップデート情報まとめ | 幻塔攻略データベース</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="幻塔 ver6.1 新アップデート内容まとめページ" />
      </Head>
      <div className="w-full max-w-full min-h-screen space-y-8 px-2 sm:px-6 py-4">
          ...
          <div className="flex gap-4 flex-wrap mb-4">
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/w_73_img.PNG" alt="ボーンクラッシャー武器" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">武器：銀牙石</span>
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/m_69_img.PNG" alt="ボーンクラッシャーボリション" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">ボリション：狼性畏るべし</span>
                <div className="text-xs mt-1 text-gray-600">詳細ページへ</div>
              </div>
            </Link>
          </div>
        ...
        <section>
          ...
          <a
            href="https://tof.perfectworld.com/jp/news/notice/20260625/262867.shtml"
            target="_blank"
