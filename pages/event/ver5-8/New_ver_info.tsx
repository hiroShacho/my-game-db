...
const costumeImages = [
  {
    src: "/ver_event/Simulacrum_Berry.PNG",
    alt: "プレアバ：ベリー「紫羽の夜巫」",
    label: "プレアバ：ベリー「紫羽の夜巫」",
    date: "04/14(火)メンテナンス後 -  05/19(火)06:00（JST）",
  },
  {
    src: "/ver_event/Simulacrum_Anka.PNG",
    alt: "【復刻】プレアバ：アンカー",
    label: "【復刻】プレアバ：アンカー",
    date: "04/14(火)メンテナンス後 -  05/19(火)06:00（JST）",
  }
...
const gachaDates = [
  {
    label: "【復刻】ガチャマシン：「田園フェアリー」",
    date: "04/14(火)メンテナンス後 -  05/02(土)06:00（JST）",
  },
  {
    label: "【復刻】ガチャマシン：「綺想魅影」",
    date: "05/02(土)13:00（JST） -  05/19(火)06:00（JST）",
  },
  {
    label: "【復刻】ガチャマシン：「モノトーン」",
    date: "05/02(土)13:00（JST） -  05/19(火)06:00（JST）",
  },
  {
    label: "【復刻】コスチュームガチャ",
  ...
  {
    label: "プレミアムアバター：ベリー「紫羽の夜巫」",
    date: "04/14(火)メンテナンス後 -  05/19(火)06:00（JST）",
  },
  {
    label: "【復刻】プレミアムアバター：アンカー",
    date: "04/14(火)メンテナンス後 -  05/19(火)06:00（JST）",
  },
];
...
export default function NewVerInfo() {
  ...
  return (
    <>
      <Head>
        <title>ver5.8アップデート情報まとめ | 幻塔攻略データベース</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="幻塔 ver5.8 新アップデート内容まとめページ" />
      </Head>
      <div className="w-full max-w-full min-h-screen space-y-8 px-2 sm:px-6 py-4">
        ...
        {/* 新キャラクター・ベリー実装！ */}
        <section>
          <SectionTitle icon={<><span title="物理">🐦‍⬛</span><span title="ベリー">⚰</span></>}>
            新キャラクター・ベリー実装！
          </SectionTitle>
          ...
          <div className="flex gap-4 flex-wrap mb-4">
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/w_71_img.PNG" alt="ベリー武器" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">武器：カロン</span>
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Image src="/images/m_67_img.PNG" alt="ベリーボリション" width={48} height={48} className="rounded border" />
                <span className="font-semibold text-sky-600">ボリション：自然の意志</span>
                <div className="text-xs mt-1 text-gray-600">詳細ページへ</div>
              </div>
            </Link>
          </div>
        ...
        <section>
          ...
          <a
            href="https://tof.perfectworld.com/jp/news/notice/20260409/261694.shtml"
            target="_blank"
