    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-2 sm:px-4 py-6">
        ...
        <div>
          ...
          加えて卵を踏んだプレイヤーにダメージUPのバフが付与されるが、同時に女王虫が狂暴化する。<br />
          卵を踏むことでデバフを解除できるので踏みたくなるが、基本的にはバフのために<strong>強攻</strong>が踏むようにしたい。<br />
          なお、卵生成のタイミングでフィールドに卵が残っていると卵の周囲に大ダメージが発生する。<br />
          そのため卵更新の前に全ての卵を潰すようにしよう.
          <CaptionedVideo
            src="/raid/SwarmGuard_4.mp4"
            caption="卵は触れるだけで潰れるので、剛毅・恩恵は全てを踏まないよう気を付けよう！"
          />
        </div>
        ...
        <div>
          ...
          強攻は序盤の内はカマグモを倒しつつ周囲の卵を定期的に踏んでバフを獲得しよう。<br />
          ...
          特にグレイフォックスの3凸効果やフィオナ連携でカマグモを倒してしまうことが多いので、バフ・回復・連携エナジー獲得以外の不要な動きはなるべくしないようにしよう。
        </div>
        ...
        <div>
          <ol className="list-decimal ml-6 space-y-2">
            ...
            <li>女王が卵リセット＆カマグモ召喚と同時に無敵状態になるので全員フィールドの端っこで逃げ回る。</li>
            <li>女王の無敵時間が終わったら卵を潰しつつカマグモを全て倒して弱体状態の女王のHPを削り、その後も攻撃を続けて斬殺ラインまでHPを削る。</li>
            <li>フィオナ/ラクシス斬殺でクリア！（フィオナなら12%～14%、ラクシスなら16%）</li>
          </ol>
        </div>
