  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-2 sm:px-4 py-6">
        ...
        <div>
          今回の討伐は一部武器の固定ダメージとギミックによるダメージを全て与えた上で31～35%のHPを削る必要がある。<br />
        ...
        <div>
          ...
          カマグモが6体、異種カマグモが4体召喚され、召喚されたカマグモたちを倒すと女王虫にダメージが入りHPの約9%を削れる。<br />
          異種カマグモを全て倒すと女王虫がその場で膝をつき、弱体状態になるのでこのタイミングでダメージを与えよう。<br />
          カマグモを召喚するタイミングは戦闘開始時と女王虫の残りHPが85%、70%、55%、40%になった時。<br />
          1回のギミックで約9%削れるので、完璧にこなせばギミックだけで約45%は削れる。<br />
          アストール剛毅かイカロス恩恵とフィオナ斬殺を合わせれば65～69%を固定ダメージで削れることになる。<br />
        ...
        <div>
          ...
          召喚タイミングと被ると強攻の火力で削らないといけないHPが約9%増えることになるため、<br />
