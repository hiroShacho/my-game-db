    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-2 sm:px-4 py-6">
        ...
        <div>
          ...
          電荷はプレイヤーだけでなくスフィアの頭上にも表示されている。プレイヤーの電荷は固定だがスフィアの電荷は一定時間ごとに変化し、一部の攻撃はスフィアと反対の電荷を持つプレイヤーに大ダメージを与えてくる。<br />
          恩恵の回復能力が高ければほとんどのギミックを無視可能だが、ギミックをクリアすることで敵にダメージを与えて弱体化可能なので全てこなした方が良い。
        </div>
        <CaptionedImage
        ...
        <div className="border-l-4 border-sky-400 pl-4 mb-6">
          ...
          <div>
            スフィアはランダムなプレイヤー2名を選択し、その足元に赤色の円とカウントダウンが表示される。<br />
          ...
          />
          <div className="mt-2">
            赤い円のギミックの後に赤円が出ていた2人を繋ぐ紫色のチェーンが出現する。<br />
            このチェーンがボスに触れるとダメージを与えられるので積極的にボスにチェーンを当てに行こう！<br />
            ちなみに赤円ギミックはプラスとマイナスの電荷を持つプレイヤーから1名ずつ選ばれているので、どちらか片方の電荷を持つプレイヤーしか生き残っていないとこのギミックでダメージを与えられないので注意しよう。
          </div>
          <CaptionedImage
        ...
        <div className="border-l-4 border-sky-400 pl-4 mb-6">
          ...
          <div>
            ...
            この攻撃はダメージの前に長めのチャージ動作があり、その間に周囲の金色ブロックを破壊することでブロックの周囲にいるプレイヤーはバリアを獲得できる。<br />
            チャージ中は赤い円のギミック以外は攻撃が飛んでこないので、恩恵フィオナの連携で単発ダメージ無効を貼っておけばノーダメージで切り抜けられる。
          </div>
          <CaptionedImage
        ...
        <div className="border-l-4 border-sky-400 pl-4 mb-6">
          ...
          <div>
            ...
            突進が中央の本体に命中するとシールドを1つ破壊でき、3体全ての突進を当てることでボスは虚弱状態になり攻撃チャンスが生まれる。<br />
            突進は分身からプレイヤーに向かって伸びる赤いライン上を転がってくるため、本体の後ろに隠れるように移動しよう。<br />
            このギミックの終了後、成功/失敗に関わらずスフィアが球形態に変化する。
          </div>
          <CaptionedImage
        ...
        <div className="border-l-4 border-cyan-400 pl-4 mb-6">
          ...
          <div>
            球形態に移行後、人形態の時にも出ていた赤い円の範囲爆発と同時に青いブロックが出現する。
          </div>
          <CaptionedImage
          ...
          />
          <div className="mt-2">
            青色のブロックに数回攻撃するか赤い円の爆発を当てることでこれを破壊でき、周囲に小型の青ブロックが出現する。<br />
            赤い円が出た2人を繋ぐ紫のチェーンをスフィアに当ててからこの小型のブロックにボスの攻撃を当てるとボスは虚弱状態になり攻撃チャンスが生まれる。<br />
            球形態時はチェーンを当てて小型ブロックにボスの攻撃を当てる流れを繰り返していくことになる。<br />
        ...
        <div className="border-l-4 border-cyan-400 pl-4 mb-6">
          ...
          <div>
            ...
            ボスの四方を取り囲む装置に対して装置と反対の電荷を持つプレイヤーが触れることで、ダメージとともにボスのシールドが1つ破壊される。<br />
            4つ全ての装置を起動してシールドが無くなるとボスは虚弱状態になり攻撃のチャンスが生まれる。<br />
            この虚弱状態から復帰した後は再び人形態に戻り、同じ流れでギミックを繰り返すことになる。<br />
            なお、ギミック中にスフィアから飛んでくる波攻撃はジャンプで避けられる。
          </div>
          <CaptionedImage
