      ...
      <div className="mx-auto max-w-3xl px-2 sm:px-4 py-6">
        ...
        <div className="border-l-4 border-cyan-400 pl-4 mb-6">
          ...
          <div>
            ...
            チェーンをボスに当てるとボスにダメージを与えると同時にフィールドに青色のブロックが出現する。
          </div>
          <CaptionedImage
          ...
          />
          <div className="mt-2">
            青色のブロックを数回攻撃して破壊すると周囲に小型の青ブロックが出現し、この小型のブロックにボスの攻撃を当てるとボスは虚弱状態になり攻撃チャンスが生まれる。<br />
            球形態時はチェーンを当てて出たブロックを破壊 ⇒ 小型ブロックにボスの攻撃を当てる流れを繰り返していくことになる。<br />
