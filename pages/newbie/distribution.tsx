  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-2 sm:px-4 py-6">
        ...
        <div className="mb-4">
          厳選について解説する前に防具についての基本的な知識を解説。<br />
        ...
        <div className="mb-4">
          ...
          理想は全てのランダムステータスが火力に繋がる4OPの状態だが、課金で手に入る防具選択箱込みでも供給量が足りていないヴェラ防具で4OPの厳選をしていると何年経っても厳選が終わらない。<br />
        ...
        <CaptionedImage
          ...
          alt="課金の選択箱に手を出しても厳選は終わってくれない..."
          caption="課金の選択箱に手を出しても厳選は終わってくれない..."
        ...
        <div className="mb-4">
          ...
          ちなみに先ほど少し触れた課金の選択箱は特にヴェラ防具が入った調諧装備選択箱の値段が高く1つで1万2千円の課金が必要となる。<br />
